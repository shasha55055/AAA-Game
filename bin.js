...
function main(user_choice){
        ...
        undisplay_hand(X);
        console.log("robo choice just ran");
...
function r_ouch(){
    const random_right = (Math.floor(Math.random()*31));
    const random_top = ((Math.floor(Math.random()*41))+20);
    setTimeout(function(){document.getElementById("ouch").style.display = "block"},2000);
    document.getElementById("ouch").style.top = `${random_top}%`;
    document.getElementById("ouch").style.right = `${random_right}%`;
}

function user_ouch(){
    const random_right = (Math.floor(Math.random()*41)+50);
    const random_top = (Math.floor(Math.random()*61));
    setTimeout(function(){document.getElementById("ouch").style.display = "block"},2000);
    document.getElementById("ouch").style.top = `${random_top}%`;
    document.getElementById("ouch").style.right = `${random_right}%`;
}
...
function unouch(){
    setTimeout(function(){document.getElementById("ouch").style.display = "none"}, 2500);
}
...
function display_reset(user_choice){
    setTimeout(function(){document.getElementById(`display_${user_choice}`).style.display = "none";}, 2500);
}

function undisplay_hand(X){
    setTimeout(function(){document.getElementById(`display_r${X}`).style.display = "none"}, 2500);
}
